...
<div class="container mb-5">
    @php
        // 8 SANAK TAGAM - Aşaky 4-siniň suratlary siz diýen ýaly düzedildi
        $foods = [
            ['name' => 'Lüle Şaşlyk', 'cat' => 'Mangal', 'img' => asset('img/images.jpg'), 'price' => 45],
            ['name' => 'Merjimek Çorbasy', 'cat' => 'Çorbalar', 'img' => asset('img/Без названия.jpg'), 'price' => 35],
            ['name' => 'Tandyr Somsa', 'cat' => 'Hamyrly', 'img' => asset('img/l_CORK_DSC_8257_1.jpg'), 'price' => 40],
            ['name' => 'Sowuk Coca-Cola', 'cat' => 'Içgiler', 'img' => asset('img/images (1).jpg'), 'price' => 10],
            
            // Täze görkezen suratlaryňyz goşuldy:
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="card food-card h-100">
                    <div class="position-relative overflow-hidden">
                        <img src="{{ $img }}" class="food-img" alt="{{ $title }}" 
                    ...
                    <div class="card-body d-flex flex-column p-4 text-center">
                        ...
                        <p class="price-tag mb-4">{{ number_format($price, 0) }}<small class="fs-6 text-muted"> m</small></p>
                        
                        <button onclick="addToCartAndGo('{{$i}}', '{{$title}}', '{{$price}}', '{{$img}}')" 
